...
LANGUAGES = [
    {
        ...
        "needs": {
            ...
            "family": "Necesito ayuda con mis hijos, o soy joven y no tengo apoyo",
    ...
    },
    {
        ...
        "needs": {
            ...
            "family": "Мне нужна помощь с детьми, или я подросток без поддержки",
            ...
            "record": "У меня судимость, или я возвращаюсь домой после заключения",
    ...
    },
    {
        ...
        "needs": {
            ...
            "veterans": "لدي خدمة عسكرية سابقة",
            "disability": "لدي إعاقة، أو أرعى شخصًا لديه إعاقة",
            "record": "لدي سجل جنائي، أو أعود إلى البيت بعد السجن",
    ...
    },
    {
        ...
        "needs": {
            ...
            "family": "مجھے بچوں کے لیے مدد چاہیے، یا میں تنہا نوجوان ہوں",
            "senior": "میں معمر ہوں، یا کسی معمر کی دیکھ بھال کرنی ہے",
            "clothes": "مجھے کپڑے، کوٹ یا بچوں کا سامان چاہیے",
            "work": "مجھے کام یا کلاسیں چاہئیں",
            "getting-there": "مجھے آنے جانے میں مدد چاہیے",
            "veterans": "میری فوجی خدمت رہی ہے",
            "disability": "مجھے معذوری ہے، یا کسی معذور شخص کی دیکھ بھال کرنی ہے",
            "record": "میرا مجرمانہ ریکارڈ ہے، یا جیل سے واپسی ہو رہی ہے",
    ...
    },
    {
        ...
        "needs": {
            ...
            "family": "J’ai besoin d’aide avec mes enfants, ou je suis jeune et sans soutien",
    ...
    },
    {
        ...
        "needs": {
            ...
            "bills": "Mam rachunek za leczenie albo ubezpieczyciel odmówił",
...
def render_overview(rows):
    ...
    # The whole masthead is one link to the narrative page. The anchor is a real
    # visible line rather than a bare overlay, so it has an accessible name, a
